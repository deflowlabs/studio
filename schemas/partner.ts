...
export default defineType({
  ...
  fields: [
    ...
    defineField({ name: 'isPublic', title: 'Approved for public display', type: 'boolean', description: 'Enable only when permission is recorded. Unapproved partners stay internal and their name, logo and URL are never exposed by the website.', initialValue: false }),
